    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantMemberRoles", x => new { x.RolesId, x.MembersUserId, x.MembersTenantId });
                    table.ForeignKey(
                        name: "FK_TenantMemberRoles_TenantMembers_MembersUserId_MembersTenantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssigneeMembersUserId = table.Column<Guid>(type: "TEXT", nullable: false),
                    AssigneeMembersTenantId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SprintTaskAssignee", x => new { x.TasksId, x.AssigneeMembersUserId, x.AssigneeMembersTenantId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SprintTaskAssignee_TenantMembers_AssigneeMembersUserId_AssigneeMembersTenantId",
                        columns: x => new { x.AssigneeMembersUserId, x.AssigneeMembersTenantId },
                        principalTable: "TenantMembers",
                        principalColumns: new[] { "UserId", "TenantId" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SprintTaskAssignee_AssigneeMembersUserId_AssigneeMembersTenantId",
                table: "SprintTaskAssignee",
                columns: new[] { "AssigneeMembersUserId", "AssigneeMembersTenantId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantMemberRoles_MembersUserId_MembersTenantId",
